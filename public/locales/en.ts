export const en = {
	...
	homePage: {
		sectionHero: {
			title: `Second Best. First in Comfort.`,
			description:
				'Second Best Homes is dedicated to offering luxury apartments in iconic locations like Downtown Dubai, placing guests at the center of renowned attractions.',
