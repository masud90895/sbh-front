...
const Page = () => {
			...
			<header className="container rounded-xl">
				<div className="mx-auto max-w-screen-md space-y-5">
					...
					<div className="flex flex-col items-baseline sm:flex-row sm:justify-between">
						<div className="nc-PostMeta2 flex flex-shrink-0 flex-wrap items-center text-start text-sm leading-none text-neutral-700 dark:text-neutral-200">
							<Avatar
	...
	const renderTags = () => {
		return (
			<div className="mx-auto flex max-w-screen-md flex-wrap gap-2">
				{['Travel', 'Lifestyle', 'Garden', 'Jewelry', 'Tools'].map((tag) => (
					<a
						key={tag}
						className="nc-Tag inline-block rounded-lg border border-neutral-100 bg-white py-2 text-sm text-neutral-600 hover:border-neutral-200 dark:border-neutral-700 dark:bg-neutral-700 dark:text-neutral-300 dark:hover:border-neutral-600 md:px-4"
						href="##"
					>
						{tag}
					</a>
		...
		return (
			<div className="mx-auto max-w-screen-md">
				<div className="nc-SingleAuthor flex">
					...
					<div className="ms-3 flex max-w-lg flex-col space-y-1 sm:ms-5">
		...
		return (
			<div className="mx-auto max-w-screen-md">
				<ul className="nc-SingleCommentLists space-y-5">
					<li>
						<Comment />
						<ul className="mt-5 space-y-5 ps-4 md:ps-11">
							<li>
								<Comment isSmall />
							</li>
						</ul>
