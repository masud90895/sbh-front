					...
					<div>
						...
						<div className="relative mt-1 rounded-md">
							...
							<input
								...
								name="minPrice"
								id="minPrice"
								className="block w-full rounded-full border-neutral-200 pe-3 ps-7 text-sm text-neutral-900 focus:border-primary-500 focus:ring-primary-500"
					...
					<div>
						...
						<div className="relative mt-1 rounded-md">
							...
							<input
								...
								name="maxPrice"
								id="maxPrice"
								className="focus:border-priring-primary-500 block w-full rounded-full border-neutral-200 pe-3 ps-7 text-sm text-neutral-900 focus:ring-primary-500"
