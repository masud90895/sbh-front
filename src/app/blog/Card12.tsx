...
const Card12: FC<Card12Props> = ({
	...
	return (
		<div className={`nc-Card12 group relative flex flex-col ${className}`}>
			...
			<div className="mt-8 flex flex-col pe-10">
				<h2 className="nc-card-title block text-lg font-semibold text-neutral-900 transition-colors dark:text-neutral-100 sm:text-2xl">
