	...
	return (
		<div className="relative pb-0 pt-24 lg:py-32 xl:py-40 2xl:py-48">
			<BackgroundSection className="bg-neutral-100 bg-opacity-80 dark:bg-opacity-100">
				...
				<div className="absolute bottom-0 end-0 hidden max-w-xl overflow-hidden rounded-3xl lg:block xl:max-w-2xl">
					<Image src={appRightImg} alt="" />
				</div>
				<div className="absolute end-0 top-0 max-w-2xl">
					<Image src={appRightImgTree} alt="" />
				</div>
				<div className="absolute bottom-10 start-0 max-w-2xl">
			...
			<div className="relative inline-block">
				...
				<div className="mt-10 flex gap-4 sm:mt-14">
					<a href="##" target="_blank" rel="noopener noreferrer">
						<Image src={btnIosPng} alt="" className="max-w-40" />
					</a>
					<a href="##" target="_blank" rel="noopener noreferrer">
						<Image src={btnAndroidPng} alt="" className="max-w-40" />
					</a>
				</div>
