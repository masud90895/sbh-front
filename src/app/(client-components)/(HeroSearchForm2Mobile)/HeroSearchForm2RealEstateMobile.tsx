...
const HeroSearchForm2RealEstateMobile = () => {
	...
	const renderButtonOpenModal = () => {
		return (
			...
			>
				<Search01Icon className="h-5 w-5 flex-shrink-0" />

				<div className="ml-3 flex-1 overflow-hidden text-left">
					<span className="block text-sm font-medium">
						{T['HeroSearchForm']['Where to?']}
					</span>
								...
								<DialogPanel className="relative flex h-full flex-1 flex-col justify-between overflow-hidden">
									{showDialog && (
										...
										>
											...
											<TabList className="flex w-full justify-center gap-x-6 pt-12 text-sm font-semibold text-neutral-500 dark:text-neutral-400 sm:gap-x-8 sm:text-base">
