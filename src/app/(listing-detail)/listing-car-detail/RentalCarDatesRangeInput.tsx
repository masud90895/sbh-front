			...
			>
				{({ open }) => (
					<>
						...
						>
							<PopoverButton className="relative flex flex-1 items-center gap-x-3 p-3 focus:outline-none">
								{renderInput()}
						...
						>
							<PopoverPanel className="absolute end-0 top-full z-10 mt-3 w-screen max-w-sm px-4 sm:px-0 lg:max-w-3xl xl:-end-10">
